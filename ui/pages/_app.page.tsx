...
// Status
  ...
  return (
	<div className={styles.container}>	
	  <Head>
        <title>zkApp [0xrivfandi]</title>
        <meta name="description" content="ZkApp By 0xrivfandi" />
		...
		<main className={styles.main}>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://t.me/Li4rNft" target="_blank" rel="noopener noreferrer" >
						<span className={styles.teleIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://discordapp.com/users/844346839763255327" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://github.com/0xrivfandi" target="_blank" rel="noopener noreferrer" >
